            ...
            <div className="col col-lg-9 col-xl-7">
              <div className="card">
                ...
                <div className="card-body p-4 text-black">
                  ...
                  <div className="mb-5">
                    <p className="lead fw-normal mb-1">Personality</p>
                    <div className="p-4" style={{ backgroundColor: '#f8f9fa' }}>
                      <p className="font-italic mb-1">When I'm not immersed in the tech world, you'll find me hiking in the great outdoors, exploring new cuisines, and mentoring aspiring tech professionals. I believe in a work-life balance that fuels creativity and personal growth.</p>
                    </div>
                  </div>
