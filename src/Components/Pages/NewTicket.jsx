...
const NewTicket = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      // Create a new ticket answer document in the "ticketanswers" collection
      const ticketAnswerDocRef = await addDoc(collection(db, 'ticketanswers'), {
        ticketId: ticketDocRef.id,
        answer: 'Ticket not started',
      });

      console.log('Ticket Document written with ID: ', ticketDocRef.id);
      console.log('Ticket Answer Document written with ID: ', ticketAnswerDocRef.id);

      setFormData(initialFormData);

      toast.success('Ticket Created Success!', { position: 'top-right' });
    } catch (error) {
      console.error('Error adding document: ', error);

      toast.error('Error creating ticket!', { position: 'top-right' });
    }
  };
